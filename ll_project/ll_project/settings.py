...
SECRET_KEY = 'django-insecure-n&vw%=ojjmlr+#e-7b7+30nh)i^(e!w_i5t51+eovglh#t&a8)'
...
LOGIN_URL = 'accounts:login' # when unauthenticated user tries to access a locked page